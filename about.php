...
<main class="main">
    ...
    <div class="services-container container">
      ...
      <div class="services-grid" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="service-card">
          <img src="assets/img/services/tour.jpg" class="service-img" alt="Expert Guides">
        ...
        <!-- Best Prices -->
        <div class="service-card">
          <img src="assets/img/services/taxi.jpg" class="service-img" alt="Best Prices">
          <div class="service-card-body">
        ...
        <!-- 24/7 Support -->
        <div class="service-card">
          <img src="assets/img/services/tour.jpg" class="service-img" alt="24/7 Support">
          <div class="service-card-body">
            <div class="service-icon service-icon--blue">
  ...
  <!-- Achievements Section (Reused from Index) -->
  ...
  <!-- Testimonials Section (Reused from Index) -->
