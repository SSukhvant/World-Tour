  <?php 
    ...
    if(isset($_GET['id'])){
      $id = $_GET['id'];
      $sql = "SELECT * FROM termandcondition WHERE id='$id'";
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h6 class="mb-4">Update Term And Condition</h6>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                              ...
                              <form action="sql/support.php?id=<?php echo $row['id'];?>" method="post">
                                ...
                                <button class="btn btn-primary w-100 m-2" name="update_termandcondition" type="submit">Update Now</button>
                              </form>
